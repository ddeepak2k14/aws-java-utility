package com.deepak.aws.service.SES;
    ...
    public static void main(String[] args) throws Exception {
       ...
       // msg.setHeader("X-SES-CONFIGURATION-SET", CONFIGSET);
        ...
        try
        {
        	...
        	//you can configure ses , so that bounced back email can be saved and tracked using sns and sqs,check document below
        	//https://aws.amazon.com/blogs/messaging-and-targeting/creating-a-daily-dashboard-to-track-bounces-and-complaints/
